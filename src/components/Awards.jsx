        ...
        <div className='awards-text'>
            <div>
               ...
               <div>
                  ...
                  <br />
                  All-India Rank of 122 in the esteemed HOMC National qualifiers 2020-21, with over 10,000 contestants participating from 50 cities across the country
               </div>
               </div>
               <div className='awards-item'>
               <div style={{width: '40px'}}><FontAwesomeIcon icon={faUserGraduate} /></div>
               <div>
                  <span className='award-text-header'> Central Board of Secondary Education (CBSE) Class 10th Board Examinations </span>
                  <br />
